...
import logo from '../../assets/img/index.jpg'
...
const Header = ({ isLogged }) => {
    ...
    return (
        <>
                ...
                <nav className="flex w-full h-5/6 m-auto items-center">
                    ...
                    <div className="flex justify-end w-full h-full items-center">
                        <button id="theme-btn" onClick={toggleTheme}
                            ...
                            <li>
                                <a href="/profil" className="flex items-center mr-4 px-4 font-semibold bg-white dark:bg-neutral-900 dark:text-white dark:hover:text-black py-2 rounded-md uppercase dark:hover:bg-neutral-300 hover:text-white hover:bg-neutral-900 font-sans shadow-md shadow-gray-500/50 duration-200 ease-in-out">
            ...
            <Menu menu={menu} isLogged={isLogged} />
        </>
    )
}
